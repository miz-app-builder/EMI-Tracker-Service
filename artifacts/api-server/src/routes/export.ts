...
router.post("/import", async (req, res) => {
  ...
  const mode = (req.query.mode as string) || "all"; // all | shops | emiOrders | payments
  ...
  const importShops  = mode === "all" || mode === "shops";
  const importOrders = mode === "all" || mode === "emiOrders" || mode === "payments";
  const importPmts   = mode === "all" || mode === "payments";
